...
namespace App\Platform\Infrastructure\ApiPlatform;
...
abstract class DomainOperation extends Operation
{
    public const OPERATION_CREATE = 'POST';
    public const OPERATION_REPLACE = 'PUT';
    public const OPERATION_APPLY = 'PATCH';
