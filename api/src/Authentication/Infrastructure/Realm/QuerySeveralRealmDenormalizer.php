...
final class QuerySeveralRealmDenormalizer implements DenormalizerInterface
{
    public function getSupportedTypes(?string $format): array
    {
        return in_array($format, ['json', 'jsonld'], true) ? [
            QuerySeveralRealm::class => false,
        ] : [];
    }
    ...
    {
        return $type === QuerySeveralRealm::class;
    }
}
