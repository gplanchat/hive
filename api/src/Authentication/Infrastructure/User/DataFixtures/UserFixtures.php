...
final readonly class UserFixtures
{
    ...
    {
        $this->storage->get('tests.data-fixtures.user.01966c5a-10ef-7abd-9c88-52b075bcae99', function (ItemInterface $item) {
            $item->tag([self::TAG]);
        ...
        $this->storage->get('tests.data-fixtures.user.01966c5a-10ef-7c83-9881-4ce08f0116f4', function (ItemInterface $item) {
            $item->tag([self::TAG]);
        ...
        $this->storage->get('tests.data-fixtures.user.01966c5a-10ef-750c-9228-d41d6f3e33a1', function (ItemInterface $item) {
            $item->tag([self::TAG]);
        ...
        $this->storage->get('tests.data-fixtures.user.01966c5a-10ef-7670-971d-e6e600135a73', function (ItemInterface $item) {
            $item->tag([self::TAG]);
        ...
        $this->storage->get('tests.data-fixtures.user.01966c5a-10ef-7d6f-a6cd-a74560cea954', function (ItemInterface $item) {
            $item->tag([self::TAG]);
        ...
        $this->storage->get('tests.data-fixtures.user.01966c5a-10ef-7040-9576-09078df3ea8a', function (ItemInterface $item) {
            $item->tag([self::TAG]);
