...
final class RoleId implements UuidInterface
{
    public const string REQUIREMENT = Requirement::UUID_V7;
    public const string URI_REQUIREMENT = '\/authentication\/'.RealmId::REQUIREMENT.'\/roles\/('.Requirement::UUID_V7.')';
    public const string PARSE = '/\/authentication\/'.RealmId::REQUIREMENT.'\/roles\/(?<reference>'.Requirement::UUID.')/';
