...
namespace App\Cloud\Management\Domain\Datacenter;
...
final class DatacenterId implements UuidInterface
{
    public const string REQUIREMENT = Requirement::UUID_V7;
    public const string URI_REQUIREMENT = '\/cloud\/datacenter\/'.Requirement::UUID_V7;
    public const string PARSE = '/\/cloud\/datacenter\/(?<reference>'.Requirement::UUID.')/';
