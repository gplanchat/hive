...
namespace App\Cloud\Management\Domain\Region;
...
final class RegionId implements UuidInterface
{
    public const string REQUIREMENT = Requirement::UUID_V7;
    public const string URI_REQUIREMENT = '\/cloud\/region\/'.Requirement::UUID_V7;
    public const string PARSE = '/\/cloud\/region\/(?<reference>'.Requirement::UUID.')/';
