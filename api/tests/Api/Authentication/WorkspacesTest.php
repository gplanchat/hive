 ...
 * @coversNothing
 */
final class WorkspacesTest extends ApiTestCase
{
    ...
    {
        self::createClient()->request('GET', '/authentication/acme-inc/workspaces', [
            'headers' => [
    ...
    {
        self::createClient()->request('GET', '/authentication/acme-inc/organizations/01966c5a-10ef-76f6-9513-e3b858c22f0a/workspaces', [
            'headers' => [
                'authorization' => 'Bearer '.self::getTokenFor('/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99'),
            ],
        ]);
    ...
    {
        self::createClient()->request('GET', '/authentication/acme-inc/workspaces/01966c5a-10ef-70ce-ab8c-c455e874c3fc', [
            'headers' => [
                'authorization' => 'Bearer '.self::getTokenFor('/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99'),
            ],
        ]);
    ...
    public function itShouldCreateAnEnabledWorkspace(): void
    {
        ...
        self::createClient()->request('POST', '/authentication/acme-inc/workspaces', [
            'json' => [
    ...
    public function itShouldCreateAnEnabledWorkspaceWithinAnOrganization(): void
    {
        ...
        self::createClient()->request('POST', '/authentication/acme-inc/organizations/01966c5a-10ef-7315-94f2-cbeec2f167d8/workspaces', [
            'json' => [
                'name' => 'Project 101',
                'slug' => 'project-101',
                'validUntil' => $validUntil,
    ...
    public function itShouldEnableADisabledWorkspace(): void
    {
        ...
        self::createClient()->request('PATCH', '/authentication/acme-inc/workspaces/01966c5a-10ef-7795-9e13-7359dd58b49c/enable', [
            'json' => [
                'enabled' => true,
                'validUntil' => $validUntil,
            ],
    ...
    public function itShouldDisableAnEnabledWorkspace(): void
    {
        ...
        self::createClient()->request('PATCH', '/authentication/acme-inc/workspaces/01966c5a-10ef-723c-bc33-2b1dc30d8963/disable', [
            'json' => [
                'enabled' => false,
                'validUntil' => $validUntil,
            ],
    ...
    {
        self::createClient()->request('DELETE', '/authentication/acme-inc/workspaces/01966c5a-10ef-723c-bc33-2b1dc30d8963', [
            'headers' => [
                'authorization' => 'Bearer '.self::getTokenFor('/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99'),
            ],
        ]);
