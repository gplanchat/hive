...
final class UsersTest extends ApiTestCase
{
    ...
    {
        self::createClient()->request('GET', '/authentication/acme-inc/users', [
            'headers' => [
    ...
    {
        self::createClient()->request('GET', '/authentication/acme-inc/organizations/01966c5a-10ef-7315-94f2-cbeec2f167d8/users', [
            'headers' => [
                'authorization' => 'Bearer '.self::getTokenFor('/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99'),
            ],
        ]);
    ...
    {
        self::createClient()->request('GET', '/authentication/acme-inc/workspaces/01966c5a-10ef-723c-bc33-2b1dc30d8963/users', [
            'headers' => [
                'authorization' => 'Bearer '.self::getTokenFor('/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99'),
            ],
        ]);
    ...
    {
        self::createClient()->request('GET', '/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99', [
            'headers' => [
                'authorization' => 'Bearer '.self::getTokenFor('/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99'),
            ],
        ]);
    ...
    {
        self::createClient()->request('POST', '/authentication/acme-inc/users', [
            'json' => [
                'organizationId' => '/authentication/acme-inc/organizations/01966c5a-10ef-7315-94f2-cbeec2f167d8',
                'workspaceIds' => [
                    '/authentication/acme-inc/workspaces/01966c5a-10ef-723c-bc33-2b1dc30d8963',
    ...
    {
        self::createClient()->request('POST', '/authentication/acme-inc/organizations/01966c5a-10ef-7315-94f2-cbeec2f167d8/users', [
            'json' => [
                'workspaceIds' => [
                    '/authentication/acme-inc/workspaces/01966c5a-10ef-723c-bc33-2b1dc30d8963',
                    '/authentication/acme-inc/workspaces/01966cc2-0323-7a38-9da3-3aeea904ea49',
    ...
    {
        self::createClient()->request('PATCH', '/authentication/acme-inc/users/01966c5a-10ef-7040-9576-09078df3ea8a/enable', [
            'json' => [
                'enabled' => true,
            ],
            'headers' => [
    ...
    {
        self::createClient()->request('PATCH', '/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99/disable', [
            'json' => [
                'enabled' => false,
            ],
            'headers' => [
    ...
    {
        self::createClient()->request('DELETE', '/authentication/acme-inc/users/01966c5a-10ef-7040-9576-09078df3ea8a', [
            'headers' => [
                'authorization' => 'Bearer '.self::getTokenFor('/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99'),
            ],
        ]);
