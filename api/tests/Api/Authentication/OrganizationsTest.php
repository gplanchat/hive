...
final class OrganizationsTest extends ApiTestCase
{
    ...
    {
        self::createClient()->request('GET', '/authentication/acme-inc/organizations', [
            'headers' => [
    ...
    public function itShouldShowAnOrganization(): void
    {
        ...
        self::createClient()->request('GET', '/authentication/acme-inc/organizations/01966c5a-10ef-7315-94f2-cbeec2f167d8', [
            'headers' => [
                'authorization' => 'Bearer '.self::getTokenFor('/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99'),
            ],
        ]);
    ...
    public function itShouldCreateAnEnabledOrganization(): void
    {
        ...
        self::createClient()->request('POST', '/authentication/acme-inc/organizations', [
            'json' => [
    ...
    public function itShouldEnableADisabledOrganization(): void
    {
        ...
        self::createClient()->request('PATCH', '/authentication/acme-inc/organizations/01966c5a-10ef-76f6-9513-e3b858c22f0a/enable', [
            'json' => [
                'enabled' => true,
                'validUntil' => $validUntil->format('Y-m-d'),
            ],
    ...
    {
        self::createClient()->request('PATCH', '/authentication/acme-inc/organizations/01966c5a-10ef-77a1-b158-d4356966e1ab/disable', [
            'json' => [
                'enabled' => false,
                'validUntil' => null,
            ],
    ...
    {
        self::createClient()->request('PATCH', '/authentication/acme-inc/organizations/01966c5a-10ef-77a1-b158-d4356966e1ab/add-features', [
            'json' => [
                'featureRolloutIds' => [
    ...
    {
        self::createClient()->request('PATCH', '/authentication/acme-inc/organizations/01966c5a-10ef-77a1-b158-d4356966e1ab/remove-features', [
            'json' => [
                'featureRolloutIds' => [
                    '/feature-rollouts/demo.lorem-ipsum',
                    '/feature-rollouts/demo.dolor-sit-amet',
    ...
    {
        self::createClient()->request('DELETE', '/authentication/acme-inc/organizations/01966c5a-10ef-77a1-b158-d4356966e1ab', [
            'headers' => [
                'authorization' => 'Bearer '.self::getTokenFor('/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99'),
            ],
        ]);
