 ...
 * @coversNothing
 */
final class FeatureRolloutsTest extends ApiTestCase
{
    ...
    {
        self::createClient()->request('GET', '/feature-rollouts', [
            'headers' => [
    ...
    {
        self::createClient()->request('GET', '/feature-rollouts/subscription.enterprise', [
            'headers' => [
                'authorization' => 'Bearer '.self::getTokenFor('/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99'),
            ],
        ]);
