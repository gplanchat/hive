...
final class RolesTest extends ApiTestCase
{
    ...
    {
        self::createClient()->request('GET', '/authentication/acme-inc/roles', [
            'headers' => [
    ...
    {
        self::createClient()->request('GET', '/authentication/acme-inc/organizations/01966c5a-10ef-7315-94f2-cbeec2f167d8/roles', [
            'headers' => [
                'authorization' => 'Bearer '.self::getTokenFor('/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99'),
            ],
        ]);
    ...
    {
        self::createClient()->request('GET', '/authentication/acme-inc/roles/01966d41-78eb-7406-ad99-03ad025e8bcf', [
            'headers' => [
                'authorization' => 'Bearer '.self::getTokenFor('/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99'),
            ],
        ]);
    ...
    {
        self::createClient()->request('POST', '/authentication/acme-inc/roles', [
            'json' => [
                'organizationId' => '/authentication/acme-inc/organizations/01966c5a-10ef-7315-94f2-cbeec2f167d8',
                'identifier' => 'manager',
                'label' => 'Manager',
    ...
    {
        self::createClient()->request('POST', '/authentication/acme-inc/organizations/01966c5a-10ef-7315-94f2-cbeec2f167d8/roles', [
            'json' => [
                'identifier' => 'manager',
                'label' => 'Manager',
                'resourceAccesses' => [],
    ...
    {
        self::createClient()->request('DELETE', '/authentication/acme-inc/roles/01969388-78d2-7530-bd4d-d7673bce9f34', [
            'headers' => [
                'authorization' => 'Bearer '.self::getTokenFor('/authentication/acme-inc/users/01966c5a-10ef-7abd-9c88-52b075bcae99'),
            ],
        ]);
